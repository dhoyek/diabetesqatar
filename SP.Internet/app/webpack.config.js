...
var bootstrapArCssExtractTextPlugin = new ExtractTextPlugin("bootstrap-iso-ar.css");
...
const config = {
    ...
    module: {
        rules: [
            ...
            }, 
            {
                ...
                // More info here: https://formden.com/blog/isolate-bootstrap
                // We used a customized CSS version of Bootstrap (http://getbootstrap.com/customize/) because we don't need the full package
                test: /bootstrap-prefix-ar\.less$/,
                use: bootstrapArCssExtractTextPlugin.extract({
                    fallback: 'style-loader',
                    use: [
                        {
                            loader: 'css-loader',
                        ...
                        },
                        {
                            ...
                            query: {
                                multiple: [
                                    { search: '\.bootstrap-iso-ar body', replace: '.bootstrap-iso-ar' },
                                    { search: '\.bootstrap-iso-ar html', replace: 'bootstrap-iso-ar' }
                                ]
                            }
                        },
                        {
    ...
    plugins: [
        ...
        bootstrapArCssExtractTextPlugin,
